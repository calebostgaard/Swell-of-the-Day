    ...
    return (
        <div>
            ...
            <div id="info">
                ...
                <h6>
                    Swell of the Day provides users with today's best surfing 
                    spot in Orange County. Choose your beach based on <a href="#windSpeed">Wind Speed</a>, <a href="#waveHeight">Wave Height</a>, <a href="#airTemp">Air Temperature</a> and <a href="#waterTemp">Water Temperature</a>
                </h6>
            </div>
